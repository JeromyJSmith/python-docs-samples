...
def list_datasets(project_id, compute_region, filter=None):
    ...
    for dataset in response:
        ...
        print(f"Dataset primary table spec id: {metadata.primary_table_spec_id}")
        print(f"Dataset target column spec id: {metadata.target_column_spec_id}")
        print(f"Dataset target column spec id: {metadata.target_column_spec_id}")
        print(f"Dataset weight column spec id: {metadata.weight_column_spec_id}")
        print(f"Dataset ml use column spec id: {metadata.ml_use_column_spec_id}")
        print(f"Dataset example count: {dataset.example_count}")
        print(f"Dataset create time: {dataset.create_time}")
        print("\n")
